...
| `shopify_find_customer` | recipe:customer_purchase_lookup, recipe:order_customer, recipe:customer_workspace, family:customer_reads | test_capability_routing.py, test_gate.py, test_observability.py, test_order_create.py, test_presentation.py, test_progressive.py, test_reads.py, test_registry.py, test_shopify_tools.py, test_ui_intent.py | order_new, order_new_ambiguous |
