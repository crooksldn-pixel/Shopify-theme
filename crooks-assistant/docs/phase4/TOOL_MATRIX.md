...
49 tools — 26 reads, 18 writes, 5 bulk — and 44 intent families.
...
**intent families with no scenario (14)**

`order_status_lookup`, `customer_purchase_lookup`, `best_sellers_period`, `sales_breakdown_period`, `stock_cover_analysis`, `inbox_state`, `compose_rewrite`, `order_new_line`, `owner_feedback`, `ui_semantics`, `returning_customers`, `returning_customers_before`, `orders_attention`, `order_list_summary`
